...
IconCheckDelegate::IconCheckDelegate(IconType icon, bool exclusive, QObject *parent)
                                  ...
                                  Qt::CheckState state) const
{
    ...
    const QPixmap &pixmap = icon.pixmap(mExclusive ? Utils::dpiScaled(QSize(16, 16)) : r.size());
